...
$(function () {
    ...
    if ($('#chartjsBar').length) {
      new Chart($("#chartjsBar"), {
        type: 'bar',
        data: {
          labels: ["Ų§ŪŲ±Ų§Ł†", "Ś†ŪŁ†", "ŲŖŲ±Ś©ŪŁ‡", "Ų¢Ł„Ł…Ų§Ł†", "Ų§Ų³ŲŖŲ±Ų§Ł„ŪŲ§"],
          datasets: [{
            label: "Ų¬Ł…Ų¹ŪŲŖ",
    ...
    if ($('#chartjsDoughnut').length) {
      new Chart($('#chartjsDoughnut'), {
        type: 'doughnut',
        data: {
          labels: ["Ų¢ŁŲ±ŪŁ‚Ų§", "Ų¢Ų³ŪŲ§", "Ų§Ų±ŁŁ¾Ų§"],
          datasets: [{
            label: "Ų¬Ł…Ų¹ŪŲŖ (Ł…ŪŁ„ŪŁŁ†)",
    ...
    if ($('#chartjsRadar').length) {
      new Chart($('#chartjsRadar'), {
        type: 'radar',
        data: {
          labels: ["Ų¢ŁŲ±ŪŁ‚Ų§", "Ų¢Ų³ŪŲ§", "Ų§Ų±ŁŁ¾Ų§", "Ų¢Ł…Ų±ŪŚ©Ų§ Ł„Ų§ŲŖŪŁ†", "Ų¢Ł…Ų±ŪŚ©Ų§ Ų´Ł…Ų§Ł„Ū"],
          datasets: [{
            label: "1301",
            fill: true,
            backgroundColor: "rgba(255,51,102,.3)",
    ...
    if ($('#chartjsPolarArea').length) {
      new Chart($('#chartjsPolarArea'), {
        type: 'polarArea',
        data: {
          labels: ["Ų¢ŁŲ±ŪŁ‚Ų§", "Ų¢Ų³ŪŲ§", "Ų§Ų±ŁŁ¾Ų§", "Ų¢Ł…Ų±ŪŚ©Ų§ Ł„Ų§ŲŖŪŁ†"],
          datasets: [{
            label: "Ų¬Ł…Ų¹ŪŲŖ (Ł…ŪŁ„ŪŁŁ†)",
