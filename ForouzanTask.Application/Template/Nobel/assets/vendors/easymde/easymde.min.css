    ...
    return function e(t, n, r) {
        ...
        10: [function (e, t, n) {
            ! function (e, r) {
                ...
                function J(e) {
                    return /\w/.test(e) || e > "Ć‚ā‚¬" && (e.toUpperCase() != e.toLowerCase() || Q.test(e))
                }
                ...
                function Ee(e) {
                    ...
                    var n = Se ? T("span", "Ć¢ā‚¬ā€¹") : T("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
                    return n.setAttribute("cm-text", ""), n
                }

                function Te(e) {
                    if (null != Fe) return Fe;
                    var t = E(e, document.createTextNode("AĆĀ®A")),
                ...
                function Qt(e) {
                    var t = T("span", "Ć¢ā‚¬Ā¢", "cm-invalidchar");
                    ...
                    if (t) {
                        ...
                        if (d.test(t)) {
                            ...
                            for (var f = 0;;) {
                                ...
                                } else "\r" == p[0] || "\n" == p[0] ? ((v = u.appendChild(T("span", "\r" == p[0] ? "Ć¢ĀĀ¨" : "Ć¢ĀĀ¤", "cm-invalidchar"))).setAttribute("cm-text", p[0]), e.col += 1) : ((v = e.cm.options.specialCharPlaceholder(p[0])).setAttribute("cm-text", p[0]), a && l < 9 ? u.appendChild(T("span", [v])) : u.appendChild(v), e.col += 1);
                ...
                $a.prototype.init = function (e) {
                        ...
                        if (t.doc.sel == t.display.selForContextMenu) {
                            ...
                            if (8203 != o || r || (r = "Ć¢ā‚¬ā€¹"), 8666 == o) return this.reset(), this.cm.execCommand("undo")
                        }
                        ...
                        function g() {
                            if (null != i.selectionStart) {
                                var e = n.somethingSelected(),
                                    o = "Ć¢ā‚¬ā€¹" + (e ? i.value : "");
                                i.value = "Ć¢ā€�Å�", i.value = o, t.prevInput = e ? "" : "Ć¢ā‚¬ā€¹", i.selectionStart = 1, i.selectionEnd = o.length, r.selForContextMenu = n.doc.sel
                            }
                        }
                        ...
                        function v() {
                            if (t.contextMenuPending == v && (t.contextMenuPending = !1, t.wrapper.style.cssText = f, i.style.cssText = h, a && l < 9 && r.scrollbars.setScrollTop(r.scroller.scrollTop = u), null != i.selectionStart)) {
                                ...
                                var e = 0,
                                    o = function () {
                                        r.selForContextMenu == n.doc.sel && 0 == i.selectionStart && i.selectionEnd > 0 && "Ć¢ā‚¬ā€¹" == t.prevInput ? ei(n, lo)(n) : e++ < 10 ? r.detectingSelectAll = setTimeout(o, 500) : (r.selForContextMenu = null, r.input.reset())
                                    };
        ...
        15: [function (e, t, n) {
            ! function (e, r) {
                ...
                function N(e) {
                    return e.replace(/---/g, "Ć¢ā‚¬ā€¯").replace(/--/g, "Ć¢ā‚¬ā€").replace(/(^|[-\u2014/(\[{"\s])'/g, "$1Ć¢ā‚¬Ė").replace(/'/g, "Ć¢ā‚¬ā„¢").replace(/(^|[-\u2014/(\[{\u2018\s])"/g, "$1Ć¢ā‚¬Å“").replace(/"/g, "Ć¢ā‚¬Ā¯").replace(/\.{3}/g, "Ć¢ā‚¬Ā¦")
                }
        ...
        18: [function (e, t, n) {
            ...
            function v(e, t, n, r, i, o) {
                ...
                l.className = e.name, l.setAttribute("type", i), n = null == n || n, e.name && e.name in r && (s[e.name] = e.action), e.title && n && (l.title = function (e, t, n) {
                    ...
                    return i
                }(e.title, e.action, r), a && (l.title = l.title.replace("Ctrl", "Ć¢Å’Ė"), l.title = l.title.replace("Alt", "Ć¢Å’Ā�"))), e.noDisable && l.classList.add("no-disable"), e.noMobile && l.classList.add("no-mobile");
                var c = [];
            ...
            var J = {
                    ...
                    "unordered-list": {
                        ...
                        title: "Ł„ŪŲ³ŲŖ ŲŗŪŲ± ŲŖŲ±ŲŖŪŲØŪ",
                        default: !0
                    },
                    "ordered-list": {
                        name: "ordered-list",
                    ...
                    image: {
                        ...
                        title: "Ł‚Ų±Ų§Ų± ŲÆŲ§ŲÆŁ† ŲŖŲµŁŪŲ±",
                        default: !0
                    },
                    "upload-image": {
                        name: "upload-image",
                        action: H,
                        className: "fa fa-image",
                        title: "Ų¢Ł¾Ł„ŁŲÆ ŲŖŲµŁŪŲ±"
                    },
                    table: {
                        name: "table",
                        action: P,
                        className: "fa fa-table",
                        title: "Ł‚Ų±Ų§Ų± ŲÆŲ§ŲÆŁ† Ų¬ŲÆŁŁ„"
                    },
                    "horizontal-rule": {
