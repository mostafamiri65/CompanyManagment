...
(function (T, O) {
    ...
    O(n, "Core/Options.js", [n["Core/Globals.js"], n["Core/Time.js"], n["Core/Color.js"], n["Core/Utilities.js"]], function (f, a, n, y) {
        ...
        f.defaultOptions = {
            ...
            lang: {
                loading: "ŲÆŲ± Ų­Ų§Ł„ ŲØŲ§Ų²ŚÆŲ²Ų§Ų±Ū...",
                months: "ŁŲ±ŁŲ±ŲÆŪŁ† Ų§Ų±ŲÆŪŲØŁ‡Ų´ŲŖ Ų®Ų±ŲÆŲ§ŲÆ ŲŖŪŲ± Ł…Ų±ŲÆŲ§ŲÆ Ų´Ł‡Ų±ŪŁŲ± Ł…Ł‡Ų± Ų¢ŲØŲ§Ł† Ų¢Ų°Ų± ŲÆŪ ŲØŁ‡Ł…Ł† Ų§Ų³ŁŁ†ŲÆ".split(" "),
                shortMonths: "ŁŲ±Ł Ų§Ų±ŲÆ Ų®Ų±ŲÆ ŲŖŪŲ± Ł…Ų±ŲÆ Ų´Ł‡Ų± Ł…Ł‡Ų± Ų¢ŲØŲ§ Ų¢Ų°Ų± ŲÆŪ ŲØŁ‡Ł… Ų§Ų³Ł".split(" "),
                weekdays: "ŪŚ©Ų´Ł†ŲØŁ‡ ŲÆŁŲ´Ł†ŲØŁ‡ Ų³Ł‡ Ų´Ł†ŲØŁ‡ Ś†Ł‡Ų§Ų±Ų´Ł†ŲØŁ‡ Ł¾Ł†Ų¬ Ų´Ł†ŲØŁ‡ Ų¬Ł…Ų¹Ł‡ Ų´Ł†ŲØŁ‡".split(" "),
                decimalPoint: ".",
                numericSymbols: "kMGTPE".split(""),
                resetZoom: "ŲØŲ§Ų²Ł†Ų´Ų§Ł†Ū Ų²ŁŁ…",
                resetZoomTitle: "ŲØŲ§Ų²Ł†Ų´Ų§Ł†Ū Ų²ŁŁ… Ų³Ų·Ų­ 1:1",
                thousandsSep: ","
            },
            global: {},
            time: {
