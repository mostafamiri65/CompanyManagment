...
$(function() {
    ...
    $.plot($('#flotLine'), [
      {
        label: 'ŲØŲ§Ų²ŲÆŪŲÆŚ©Ł†Ł†ŲÆŚÆŲ§Ł†',
        data: [
          [ 6, 196 ], [ 7, 175 ], [ 8, 212 ], [ 9, 247 ], [ 10, 152 ], [ 11, 225 ], [ 12, 155 ], [ 13, 203 ], [ 14, 166 ], [ 15, 151 ]
        ]
      },
      {
        label: 'ŲØŲ§Ų²ŲÆŪŲÆŚ©Ł†Ł†ŲÆŚÆŲ§Ł† Ł‡Ł…ŪŲ´ŚÆŪ',
        data: [
    ...
    // Pie Chart
    $.plot($('#flotPie'), [
      { label: 'Ų³Ų±Ū1', data: 77 },
      { label: 'Ų³Ų±Ū2', data: 81 },
      { label: 'Ų³Ų±Ū3', data: 46 },
      { label: 'Ų³Ų±Ū4', data: 35 },
      { label: 'Ų³Ų±Ū5', data: 79 },
      { label: 'Ų³Ų±Ū6', data: 84 },
    ], {
      series: {
        shadowSize: 0,
        pie: {
