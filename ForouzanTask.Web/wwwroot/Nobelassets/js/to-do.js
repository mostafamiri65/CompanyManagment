! function (e) {
    e(document).ready(function () {
            ...
            t = function () {
                ...
                if ("" == s) e("#new-task").addClass("error"), e(".new-task-wrapper .error-message").removeClass("hidden");
                    ...
                    var t = e(".todo-list-body").prop("scrollHeight"),
                        l = e(o).clone();
                    l.find(".task-label").text(s), l.addClass("new"), l.removeClass("completed"), e("#todo-list").append(l), e("#new-task").val(""), e("#mark-all-finished").removeClass("move-up"), e("#mark-all-incomplete").addClass("move-down"), a(s, " ŲØŁ‡ Ł„ŪŲ³ŲŖ Ų§Ų¶Ų§ŁŁ‡ Ų´ŲÆ"), e(".todo-list-body").animate({
                        scrollTop: t
                    }, 1e3)
                }
            },
        ...
        e(".add-task-btn").click(function () {
            ...
            s.remove(), a(t, "  Ų­Ų°Ł Ų´ŲÆŁ‡ Ų§Ų³ŲŖ.")
        }), e("#todo-list").on("click", ".task-action-btn .complete-btn", function () {
            var s = e(this).closest(".task"),
                t = s.find(".task-label").text(),
                l = s.hasClass("completed") ? "Ų¹Ł„Ų§Ł…ŲŖ ŚÆŲ°Ų§Ų±Ū Ų§Ł†Ų¬Ų§Ł… Ų´ŲÆŁ‡" : "Ų¹Ł„Ų§Ł…ŲŖ ŚÆŲ°Ų§Ų±Ū Ų§Ł†Ų¬Ų§Ł… Ł†Ų´ŲÆŁ‡";
            e(this).attr("title", l), s.hasClass("completed") ? a(t, "ŲØŁ‡ Ų¹Ł†ŁŲ§Ł† Ų§Ł†Ų¬Ų§Ł… Ł†Ų´ŲÆŁ‡ Ų¹Ł„Ų§Ł…ŲŖ ŚÆŲ°Ų§Ų±Ū Ų´ŲÆ.") : a(t, "ŲØŁ‡ Ų¹Ł†ŁŲ§Ł† Ų§Ł†Ų¬Ų§Ł… Ų´ŲÆŁ‡ Ų¹Ł„Ų§Ł…ŲŖ ŚÆŲ°Ų§Ų±Ū Ų´ŲÆ.", "success"), s.toggleClass("completed")
            ...
            e("#todo-list .task").addClass("completed"), e("#mark-all-incomplete").removeClass("move-down"), e(this).addClass("move-up"), a("Ł‡Ł…Ł‡ ŁŲøŲ§ŪŁ", "ŲØŁ‡ Ų¹Ł†ŁŲ§Ł† Ų§Ł†Ų¬Ų§Ł… Ų´ŲÆŁ‡ Ų¹Ł„Ų§Ł…ŲŖ ŚÆŲ°Ų§Ų±Ū Ų´ŲÆŁ‡ Ų§Ų³ŲŖ.", "success")
        }), e("#mark-all-incomplete").click(function () {
            e("#todo-list .task").removeClass("completed"), e(this).addClass("move-down"), e("#mark-all-finished").removeClass("move-up"), a("Ł‡Ł…Ł‡ ŁŲøŲ§ŪŁ", "ŲØŁ‡ Ų¹Ł†ŁŲ§Ł† Ų§Ł†Ų¬Ų§Ł… Ł†Ų´ŲÆŁ‡ Ų¹Ł„Ų§Ł…ŲŖ ŚÆŲ°Ų§Ų±Ū Ų´ŲÆŁ‡ Ų§Ų³ŲŖ.")
        })
    })
  }(jQuery);