...
! function (t, e) {
    ...
    var C = {
        name: "en",
        options: {
          months: ["ŲÆŪ", "ŲØŁ‡Ł…Ł†", "Ų§Ų³ŁŁ†ŲÆ", "ŁŲ±ŁŲ±ŲÆŪŁ†", "Ų§Ų±ŲÆŪŲØŁ‡Ų´ŲŖ", "Ų®Ų±ŲÆŲ§ŲÆ", "ŲŖŪŲ±", "Ł…Ų±ŲÆŲ§ŲÆ", "Ų´Ł‡Ų±ŪŁŲ±", "Ł…Ł‡Ų±", "Ų¢ŲØŲ§Ł†", "Ų¢Ų°Ų±"],
          shortMonths: ["ŲÆŪ", "ŲØŁ‡Ł…Ł†", "Ų§Ų³ŁŁ†ŲÆ", "ŁŲ±ŁŲ±ŲÆŪŁ†", "Ų§Ų±ŲÆŪŲØŁ‡Ų´ŲŖ", "Ų®Ų±ŲÆŲ§ŲÆ", "ŲŖŪŲ±", "Ł…Ų±ŲÆŲ§ŲÆ", "Ų´Ł‡Ų±ŪŁŲ±", "Ł…Ł‡Ų±", "Ų¢ŲØŲ§Ł†", "Ų¢Ų°Ų±"],
          days: ["ŪŚ©Ų´Ł†ŲØŁ‡", "ŲÆŁŲ´Ł†ŲØŁ‡", "Ų³Ł‡ Ų´Ł†ŲØŁ‡", "Ś†Ł‡Ų§Ų±Ų´Ł†ŲØŁ‡", "Ł¾Ł†Ų¬ Ų´Ł†ŲØŁ‡", "Ų¬Ł…Ų¹Ł‡", "Ų´Ł†ŲØŁ‡"],
          shortDays: ["ŪŚ©Ų´Ł†ŲØŁ‡", "ŲÆŁŲ´Ł†ŲØŁ‡", "Ų³Ł‡ Ų´Ł†ŲØŁ‡", "Ś†Ł‡Ų§Ų±Ų´Ł†ŲØŁ‡", "Ł¾Ł†Ų¬ Ų´Ł†ŲØŁ‡", "Ų¬Ł…Ų¹Ł‡", "Ų´Ł†ŲØŁ‡"],
          toolbar: {
            exportToSVG: "SVG ŲÆŲ§Ł†Ł„ŁŲÆ ŲØŲ§ ŁŲ±Ł…ŲŖ",
            exportToPNG: "PNG ŲÆŲ§Ł†Ł„ŁŲÆ ŲØŲ§ ŁŲ±Ł…ŲŖ",
            exportToCSV: "CSV ŲÆŲ§Ł†Ł„ŁŲÆ ŲØŲ§ ŁŲ±Ł…ŲŖ",
            menu: "ŁŁ‡Ų±Ų³ŲŖ",
            selection: "Ų§Ł†ŲŖŲ®Ų§ŲØ",
            selectionZoom: "Ų§Ł†ŲŖŲ®Ų§ŲØ Ų²ŁŁ…",
            zoomIn: "Ų§ŁŲ²Ų§ŪŲ´ Ų²ŁŁ…",
            zoomOut: "Ś©Ų§Ł‡Ų´ Ų²ŁŁ…",
            pan: "Ł…ŲŖŲ­Ų±Ś©",
            reset: "ŲØŲ§Ų²ŚÆŲ±ŲÆŲ§Ł†Ū Ų²ŁŁ…"
          }
        }
      },
      L = function () {
        ...
        return r(t, [{
          ...
          value: function (t, e) {
            ...
            return e && !s && (s = e.config.series), a && s.length !== t.yaxis.length && s.length && (t.yaxis = s.map((function (e, a) {
              if (e.name || (s[a].name = "Ų³Ų±Ū-".concat(a + 1)), t.yaxis[a]) return t.yaxis[a].seriesName = s[a].name, t.yaxis[a];
        ...
        return r(t, [{
          ...
          value: function (t) {
            ...
            for (var n = function () {
              ...
              s.seriesZ.push(this.threeDSeries), void 0 !== t[l].name ? s.seriesNames.push(t[l].name) : s.seriesNames.push("Ų³Ų±Ū-" + parseInt(l + 1, 10)), void 0 !== t[l].color ? s.seriesColors.push(t[l].color) : s.seriesColors.push(void 0)
            }
            return this.w
          }
        }, {
          ...
          value: function (t) {
            ...
            for (var a = 0; a < e.series.length; a++) void 0 === e.seriesNames[a] && e.seriesNames.push("Ų³Ų±Ū-" + (a + 1));
            return this.w
          }
        }, {
        ...
        return r(t, [{
          ...
          value: function (t) {
            ...
            l.push(n.config.chart.toolbar.export.csv.headerCategory), i.map((function (t, e) {
              var i = t.name ? t.name : "Ų³Ų±Ū-".concat(e);
              n.globals.axisCharts && l.push(i.split(s).join("") ? i.split(s).join("") : "Ų³Ų±Ū-".concat(e))
