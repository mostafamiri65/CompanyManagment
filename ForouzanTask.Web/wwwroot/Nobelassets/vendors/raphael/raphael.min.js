    ...
    return function (t) {
        ...
        i = [r(2)], void 0 === (n = function (t) {
            ...
            var it = function (t) {
                    if (e.vml) {
                        ...
                        s.title = "RaphaĆĀ«l Colour Picker", s.style.display = "none", l.doc.body.appendChild(s), it = ht(function (t) {
            ...
            e.getRGB = ht(function (t) {
                ...
                return h ? (h[2] && (n = F(h[2].substring(5), 16), i = F(h[2].substring(3, 5), 16), r = F(h[2].substring(1, 3), 16)), h[3] && (n = F((s = h[3].charAt(3)) + s, 16), i = F((s = h[3].charAt(2)) + s, 16), r = F((s = h[3].charAt(1)) + s, 16)), h[4] && (l = h[4][v](D), r = z(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), i = z(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), n = z(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), "rgba" == h[1].toLowerCase().slice(0, 4) && (a = z(l[3])), l[3] && "%" == l[3].slice(-1) && (a /= 100)), h[5] ? (l = h[5][v](D), r = z(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), i = z(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), n = z(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), ("deg" == l[0].slice(-3) || "Ć‚Ā°" == l[0].slice(-1)) && (r /= 360), "hsba" == h[1].toLowerCase().slice(0, 4) && (a = z(l[3])), l[3] && "%" == l[3].slice(-1) && (a /= 100), e.hsb2rgb(r, i, n, a)) : h[6] ? (l = h[6][v](D), r = z(l[0]), "%" == l[0].slice(-1) && (r *= 2.55), i = z(l[1]), "%" == l[1].slice(-1) && (i *= 2.55), n = z(l[2]), "%" == l[2].slice(-1) && (n *= 2.55), ("deg" == l[0].slice(-3) || "Ć‚Ā°" == l[0].slice(-1)) && (r /= 360), "hsla" == h[1].toLowerCase().slice(0, 4) && (a = z(l[3])), l[3] && "%" == l[3].slice(-1) && (a /= 100), e.hsl2rgb(r, i, n, a)) : ((h = {
                    r: r,
                    g: i,
                    b: n,
                    toString: ut
            ...
            e.findDotsAtSegment = function (t, e, r, i, n, a, s, o, l) {
                ...
                return function () {
                    t("raphael.log", null, "RaphaĆĀ«l: you are calling to method Ć¢ā‚¬Å“" + e + "Ć¢ā‚¬Ā¯ of removed object", e)
                }
            };
            ...
            function Ht() {
                return this.x + g + this.y + g + this.width + " Ćā€” " + this.height
            }
            ...
            Wt.animateWith = function (t, r, i, n, a, s) {
                ...
                return "RaphaĆĀ«lĆ¢ā‚¬ā„¢s object"
            };
        ...
        i = [r(0)], void 0 === (n = function (t) {
            if (!t || t.svg) {
                var e = "hasOwnProperty",
                    ...
                    g = {};
                t.toString = function () {
                    return "Your browser supports SVG.\nYou are running RaphaĆĀ«l " + this.version
                };
                var x = function (i, n) {
                        if (n)
                ...
                S.prototype = T, T.constructor = S, t._engine.path = function (t, e) {
                    ...
                    this.bottom = this.top = null, (this.desc = x("desc")).appendChild(t._g.doc.createTextNode("Created with RaphaĆĀ«l " + t.version)), e.appendChild(this.desc), e.appendChild(this.defs = x("defs"))
        ...
        i = [r(0)], void 0 === (n = function (t) {
            if (!t || t.vml) {
                ...
                t.toString = function () {
                    return "Your browser doesnĆ¢ā‚¬ā„¢t support SVG. Falling down to VML.\nYou are running RaphaĆĀ«l " + this.version
                };
